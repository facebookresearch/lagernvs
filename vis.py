...
def create_target_camera_path(
    ...
    images = load_and_preprocess_images(image_names, mode="crop", target_size=518).to(
        device
    )
    ...
    # sufficient here since intrinsics only affect the target ray directions,
    # not the model's conditioning.
