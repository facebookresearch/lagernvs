...
def extri_intri_to_pose_encoding(
    ...
    Args:
        extrinsics (torch.Tensor): Camera extrinsic parameters with shape BxSx3x4,
            ...
            # VGGT uses OpenCV coordinate system (x-right, y-down, z-forward), and camera from world transformation.
            # This transformation function is invariant of the coordinate system, because
            # it's just a 1-to-1 mapping between the matrix and a vector.
            The format is [R|t] where R is a 3x3 rotation matrix and t is a 3x1 translation vector.
        intrinsics (torch.Tensor): Camera intrinsic parameters with shape BxSx4.
            Defined in pixels, with format: [fx, fy, cx, cy],
