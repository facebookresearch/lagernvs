...
def load_and_preprocess_images(
    ...
    Args:
        ...
        mode (str, optional): Preprocessing mode.
                             ...
                             - "square_crop": Center-crops to square at original resolution, then resizes
                               to target_size x target_size. Matches the eval pipeline behavior.
    ...
    # Validate mode
    if mode not in ["crop", "pad", "square_crop"]:
        raise ValueError("Mode must be 'crop', 'pad', or 'square_crop'")
    ...
    for image_path in image_path_list:
        ...
        if mode == "square_crop":
            # Center-crop to square at original resolution, then resize
